...
export const Toast = ({ message, type = 'info', duration = 3000, position = 'bottom', onClose, textStyle = {}, containerStyle = {}, }) => {
...
const styles = StyleSheet.create({
    toast: Object.assign({ position: 'absolute', left: 20, right: 20, padding: 15, borderRadius: 8, flexDirection: 'row', alignItems: 'center', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84 }, (Platform.OS === 'ios' ? {} : { zIndex: 9999 })),
    indicator: {
        marginRight: 10,
        fontSize: 16,
    },
